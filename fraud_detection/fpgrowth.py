...
if __name__ == "__main__":
    ...
    parsedDat = [line.split() for line in open('dataset/fpm_medicine_analysis.csv',encoding='utf-8').readlines()]
    initSet = createInitSet(parsedDat)
    myFPtree, myHeaderTab = createTree(initSet,3)
    myFreList = []
    mineTree(myFPtree, myHeaderTab,3, set([]), myFreList)
    print("频繁模式挖掘：",len(myFreList))
